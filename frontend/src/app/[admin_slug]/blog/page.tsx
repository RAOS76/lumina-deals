...
import ContentActions from '@/components/admin/ContentActions'; // We might need to adapt this or create a new one
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500">Gestiona los artículos y noticias.</p>
                </div>
                <Link
                    href={`/${admin_slug}/blog/new`}
                        ...
                        <tbody className="divide-y divide-slate-100">
                            ...
                            {posts?.map((post) => (
                                <tr key={post.id} className="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <span
                                            className={`px-2 py-1 rounded-lg text-xs font-bold uppercase ${post.published
